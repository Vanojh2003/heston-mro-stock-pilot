...
import { Droplet, Wrench, Settings } from 'lucide-react';
...
export const MainDashboard = ({ onNavigate }: MainDashboardProps) => {
  const modules = [
    ...
    },
    {
      ...
      description: 'Staff management and system settings',
      icon: Settings,
    ...
    <div className="space-y-8">
      <div className="text-center">
        <h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">
          HESTON MRO Stock Management System
        </h1>
      ...
      <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6 mt-8">
        ...
        <p className="text-yellow-700 dark:text-yellow-300">
          This system helps you track and manage oil inventory, parts, and staff. 
          All modules are available for use without restrictions.
        </p>
      </div>
    </div>
  );
